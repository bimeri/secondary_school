<style>
    ...
    <div class="container w3-white view-box" style="width: 95%; margin-top: 0px;">
        ...
        <center>
        <em style="font-size: 25px; font-weight: bold;">Income statement for {{ $expenseName }}, for the academic year: {{ $year }}</em>
        </center><hr class="divide">
    ...
    <table class="w3-table w3-striped" style="font-size: 16px !important;">
        ...
        @endforeach
        <tr><td colspan="5" class="teal lighten-4 teal-text center">Total Sum of Expense on {{ $expenseName }}: <b>{{ $sum }}FCFA</b></td></tr>
    </table>
    </div>
