            ...
            <table class="w3-table w3-striped w3-border-teacher" style="font-size: 15px !important;">
                ...
                <tbody id="clear">
                    ...
                    <tr>
                        ...
                        <td>{{ $subject['class'] }}</td>
                        <td><a href="{{  route('teacher.upload.assignment', ['subjectId' => Crypt::encrypt($subject['sub_id']), 'yearId' => Crypt::encrypt($yearId)]) }}" class="w3-btn w3-teal w3-teacher w3-small lighten-1 waves-effect waves-light">Assignment <i class="fa fa-wrench w3-small"></i></a></td>
